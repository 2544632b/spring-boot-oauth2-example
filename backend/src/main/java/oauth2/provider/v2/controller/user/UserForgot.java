...
import oauth2.provider.v2.model.form.request.user.forgot.ForgotPasswordForm;
...
import oauth2.provider.v2.service.profile.user.forgot.ForgotUserInfoService;
