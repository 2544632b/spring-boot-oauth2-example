...
import oauth2.provider.v2.model.form.request.user.change.PasswordChangeForm;
...
public class UserChange {
    ...
    @Resource
    private oauth2.provider.v2.service.profile.user.change.ChangeUserDetailsService ChangeUserDetailsService;
